...
class CategoriesApi(object):
    ...
    def update_month_category(self, budget_id, month, category_id, data, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.update_month_category_with_http_info(budget_id, month, category_id, data, **kwargs)  # noqa: E501
            return data
    ...
    def update_month_category_with_http_info(self, budget_id, month, category_id, data, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('data' not in params or
            ...
            raise ValueError("Missing the required parameter `data` when calling `update_month_category`")  # noqa: E501
