...
class ScheduledTransactionSummary(object):
    ...
    def __init__(self, id=None, date_first=None, date_next=None, frequency=None, amount=None, memo=None, flag_color=None, account_id=None, payee_id=None, category_id=None, transfer_account_id=None, deleted=None, _configuration=None):  # noqa: E501
    ...
    def date_first(self, date_first):
        ...
        :type: date
        """
        if self._configuration.client_side_validation and date_first is None:
    ...
    def date_next(self, date_next):
        ...
        :type: date
        """
        if self._configuration.client_side_validation and date_next is None:
