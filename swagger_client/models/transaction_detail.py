...
class TransactionDetail(object):
    ...
    def __init__(self, account_name=None, payee_name=None, category_name=None, subtransactions=None, _configuration=None):  # noqa: E501
    ...
    def subtransactions(self, subtransactions):
        ...
        """
        if self._configuration.client_side_validation and subtransactions is None:
