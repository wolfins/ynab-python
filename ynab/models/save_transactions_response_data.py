...
class SaveTransactionsResponseData(object):
    ...
    def __init__(self, transaction_ids=None, transaction=None, transactions=None, duplicate_import_ids=None, server_knowledge=None, _configuration=None):  # noqa: E501
    ...
    def transaction(self):
        ...
        If a single transaction was specified, the transaction that was saved  # noqa: E501
    ...
    def server_knowledge(self, server_knowledge):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and server_knowledge is None:
