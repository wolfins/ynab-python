...
class TransactionsApi(object):
    ...
    def create_transaction(self, budget_id, data, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.create_transaction_with_http_info(budget_id, data, **kwargs)  # noqa: E501
            return data
    ...
    def create_transaction_with_http_info(self, budget_id, data, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('data' not in params or
            ...
            raise ValueError("Missing the required parameter `data` when calling `create_transaction`")  # noqa: E501
    ...
    def update_transaction(self, budget_id, transaction_id, data, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.update_transaction_with_http_info(budget_id, transaction_id, data, **kwargs)  # noqa: E501
            return data
    ...
    def update_transaction_with_http_info(self, budget_id, transaction_id, data, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('data' not in params or
                                                       params['data'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `data` when calling `update_transaction`")  # noqa: E501
    ...
    def update_transactions(self, budget_id, data, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.update_transactions_with_http_info(budget_id, data, **kwargs)  # noqa: E501
            return data
    ...
    def update_transactions_with_http_info(self, budget_id, data, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('data' not in params or
                                                       params['data'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `data` when calling `update_transactions`")  # noqa: E501
