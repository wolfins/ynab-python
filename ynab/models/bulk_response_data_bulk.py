...
class BulkResponseDataBulk(object):
    ...
    def __init__(self, transaction_ids=None, duplicate_import_ids=None, _configuration=None):  # noqa: E501
    ...
    def duplicate_import_ids(self, duplicate_import_ids):
        ...
        :type: list[str]
        """
        if self._configuration.client_side_validation and duplicate_import_ids is None:
