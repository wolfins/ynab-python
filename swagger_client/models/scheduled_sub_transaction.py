...
class ScheduledSubTransaction(object):
    ...
    def __init__(self, id=None, scheduled_transaction_id=None, amount=None, memo=None, payee_id=None, category_id=None, transfer_account_id=None, deleted=None, _configuration=None):  # noqa: E501
    ...
    def scheduled_transaction_id(self, scheduled_transaction_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and scheduled_transaction_id is None:
